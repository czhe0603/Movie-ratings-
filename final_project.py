...
def setUpStackerTable(cur, conn):
    cur.execute('DROP TABLE IF EXIXTS Stacker')
...
def setUpTMDBTable(cur, conn):
    cur.execute('DROP TABLE IF EXIXTS TMDB')
...
def setUpIMDBTable(cur, conn):
    cur.execute('DROP TABLE IF EXIXTS IMDB')
...
def JoinTables(cur, conn):
    cur.execute('DROP TABLE IF EXIXTS All_Table')
...
def Average(cur, conn):
    cur.execute('DROP TABLE IF EXIXTS Ave_Table')
    cur.execute(
        """
